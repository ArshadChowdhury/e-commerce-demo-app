    ...
    <div className='rounded-lg shadow-lg my-20 flex flex-row'>
      <div className='w-full lg:w-3/5 bg-gradient-to-r from-black to-purple-900 lg:from-black lg:via-purple-900 lg:to-transparent rounded-lg text-gray-100 p-12'>
        <div className='lg:w-1/2'>
          ...
          <div>
            <input type="email" placeholder='Enter your email address' className='bg-gray-600 text-gray-200 placeholder-gray-400 p-3 w-full rounded-lg focus:outline-none text-xl' />
            <button type='submit' className='bg-red-600 py-3 rounded-lg w-full my-2'>Subscribe</button>
          </div>
        </div>
      </div>
