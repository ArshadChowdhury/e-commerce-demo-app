...
import { productsData , womenProductsData} from "./productsData";
...
const Collections = () => {
  return (
    <>
              ...
              <div className="shadow-lg rounded-lg bg-gray-600">
                ...
                <div className="p-5">
                  ...
                  <div className="flex flex-col xl:flex-row justify-between">
                    ...
                    <Link
                      href={`/products/${product.id}`}
                      className="bg-purple-600 py-1 px-3 rounded-xl hover:bg-purple-800"
                    >
                      {" "}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
      ...
      <div>
        <div className="flex flex-row justify-between mt-20 mb-5 items-center">
          <h2 className="text-3xl">Collection for Women</h2>
          <Link href="/products" className="text-xl flex flex-row items-center">
            View All
            <svg
              xmlns="http://www.w3.org/2000/svg"
